...
<body class="">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            background: linear-gradient(180deg,#7c4005 -20%, #FF9933 59%,#FF9933 100%);">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column" role="navigation">
                        ...
                        <li class="nav-item">
                            <a href="/dashboard" class="nav-link" title="Dashboard" data-pjax>
                        ...
                        <li class="nav-item">
                            <a href="/employees" class="nav-link" title="Customer" data-pjax>
                        ...
                        <li class="nav-item">
                            <a href="/employees/create" class="nav-link" title="Customer" data-pjax>
                        ...
                        <li class="nav-item title">Salaries</li>
                        <li class="nav-item">
                            <a href="/salaries/details" class="nav-link" title="Orders">

                                <span>
                                    <i class="fas fa-inbox fa-fw"></i>
                                    Calculated Salaries</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/salaries" class="nav-link" title="Orders">
                        ...
                        <li class="nav-item">
                            <a href="/salaries/create" class="nav-link " title="Orders">
                                <span>
                                    <i class="fas fa-inbox fa-fw"></i>
                                    New Salary </span>
                            </a>
